...
namespace DAL.Migrations
{
    ...
    [Migration("20211205204923_ChangeParentChild")]
    partial class ChangeParentChild
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CIL.Models.User", b =>
                {
                    ...
                    b.Property<string>("UserKnowledgeLevel")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CIL.Models.ParentChild", b =>
                {
                    b.HasOne("CIL.Models.User", "Child")
                        .WithMany("UserChilds")
                        .HasForeignKey("ChildId");

                    b.HasOne("CIL.Models.User", "Parent")
